            ...
            <div className="collapse text-bg-dark" id="navbarHeader">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-4 offset-md-1 py-4"><h4>Meni</h4>
                            <ul className="list-unstyled">
                                <li><Link to='/'>Domov</Link></li>
                                <li><Link to='/locations'>Lokacije</Link></li>
                                {!isAuthenticated ? (
                                    <>
                                    ...
                                    <>
                                        <li><button onClick={handleLogout} className='btn btn-sm'>Odjava</button></li>
                                    </>
                                )}
